...
public class GameWindow
{
    ...
    public static int     wndWidth;       /*!< latimea ferestrei in pixeli*/
    public static int     wndHeight;      /*!< inaltimea ferestrei in pixeli*/
...
//        ImageIcon icon= new ImageIcon("secret_key.png");
//        JLabel label=new JLabel(icon);
//        label.setBounds(700,0,10,10);
//        panel.add(label);
